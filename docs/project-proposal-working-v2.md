...
Despite its wealth of attractions, Matara lacks a centralised, reliable source of tourist information at the local level. Visitors must piece together itinerary details from multiple, often outdated, online sources, making it difficult to plan an efficient and enjoyable one-day visit. TourMind is a web-based system designed to address this gap by providing organised, host-curated information about places of interest within a 25 km radius of a homestay located in Matara town centre, enabling tourists to plan their visit with confidence.
...
The aim of this project is to design and implement a web-based system, TourMind, that enables tourists to access organised, host-curated information about places of interest within a 25 km radius of a homestay in Matara town centre, Sri Lanka, and to plan a personalised one-day visit itinerary.

---

## Project Objectives

1. To identify and document a minimum of 10 places of interest within a 25 km radius of the Matara town centre homestay, covering the three defined categories: historical and religious sites, beaches and nature, and restaurants and local food.
...
The system will cover a minimum of 10 places of interest located within a 25 km radius of the Matara town centre homestay, spanning three primary categories: historical and religious sites, beaches and nature, and restaurants and local food. The system will provide tourists with the ability to view place listings, filter by category, read essential details, view locations on a map, and compose a one-day visit plan. A separate host interface will allow the homestay owner to manage place information through add, edit, and delete operations.

The representative places of interest to be included are:

| # | Place | Category |
|---|-------|----------|
| 1 | Matara Fort | Historical & religious |
| 2 | Star Fort and Museum | Historical & religious |
| 3 | Dutch Reformed Church | Historical & religious |
| 4 | Paravi Duwa Buddhist Temple | Historical & religious |
| 5 | Weherahena Temple | Historical & religious |
| 6 | Wewurukannala Viharaya, Dickwella | Historical & religious |
| 7 | Dondra Head Lighthouse | Historical & religious |
| 8 | Polhena Beach | Beach & nature |
| 9 | Mirissa Beach and Coconut Tree Hill | Beach & nature |
| 10 | Nilwala River Safari | Beach & nature |
| 11 | Madiha Beach | Beach & nature |
| 12 | Matara Local Market and Street Food Area | Restaurants & local food |
...
TourMind addresses a genuine and underserved need in the local tourism landscape of Matara, Sri Lanka. By consolidating host-curated information about places of interest into a single, accessible web platform — organised across the categories of historical and religious sites, beaches and nature, and restaurants and local food — the system has the potential to meaningfully improve the experience of tourists visiting the area while also providing a practical tool for the homestay host to promote local attractions. As a university module project, TourMind provides an opportunity to apply full-stack web development skills in a real-world context, from database design and REST API development to responsive frontend implementation. The expected outcome is a functional, well-structured system that demonstrates both technical competence and practical value as a locally managed tourism information platform.
